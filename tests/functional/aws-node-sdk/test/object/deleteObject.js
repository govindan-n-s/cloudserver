        ...
        describe('with object lock', () => {
            ...
            before(() => {
                ...
                return s3.createBucketPromise({
                    Bucket: bucketName,
                    ObjectLockedEnabledForBucket: true,
                })
                .catch(err => {
                ...
                .then(res => {
                    ...
                    process.stdout('putting object retention\n');
                ...
                .catch(err => {
                    process.stdout.write('Err putting object or object ' +
                        `retention ${err}\n`);
                    throw err;
                })
                .then(() => {
                    ...
                    return s3.putObject({
                        Bucket: bucketName,
                        Object: objectNameTwo,
                    });
                })
                .then(res => {
                    versionIdTwo = res.VersionId;
                    process.stdout('putting object legal hold\n');
