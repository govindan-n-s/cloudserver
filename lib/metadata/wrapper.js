...
const {objectLayerClient} = require('./HclMetadata.js');
...
}  else if (config.backends.metadata === 'hcl_backend') {
    client = objectLayerClient ;
    implName = 'objectlayer';
...
const metadata = {
    createBucket: (bucketName, bucketMD, log, cb) => {
        log.info('------------------------------------------------------------::: creating bucket in metadata :::--------------------------------');
        client.Create({name: bucketName},(err,status)=>{
          console.log('==========================================================::: after creating bucket in metadata :::--------------------------------' , status , err);
	  cb();
        });        
    },
